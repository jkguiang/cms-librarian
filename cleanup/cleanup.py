...
class MessyDir:
    def __init__(self, path, min_chunk_size):
        self.path = path
        self.root_files = glob.glob(f"{path}/*.root")
...
if __name__ == "__main__":
    ...
    args = cli.parse_args()
    cleanup(args.basedir, min_chunk_size=args.chunksize)
